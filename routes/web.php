...
Route::group(['middleware' => ['auth']], function () {
    ...
    ##Catalago General de Lista Unidades
    Route::get('/configuracion/unidad/getListaUnidadesCatalago', 'Configuracion\UnidadController@getListaUnidadesCatalago');
    Route::get('/configuracion/unidad/getListaUnidadesCatalagoById', 'Configuracion\UnidadController@getListaUnidadesCatalagoById');


    ##Bancos
    Route::get('/configuracion/banco/getListBancos', 'Configuracion\BancoController@getListBancos');
    Route::post('/configuracion/banco/setRegistraBanco', 'Configuracion\BancoController@setRegistraBanco');
    Route::get('/configuracion/banco/getBancoEdit', 'Configuracion\BancoController@getBancoEdit');
    Route::post('/configuracion/banco/setEditarBanco', 'Configuracion\BancoController@setEditarBanco');
    Route::post('/configuracion/banco/setCambiarEstadoBanco', 'Configuracion\BancoController@setCambiarEstadoBanco');
    ...
    Route::get('/operacion/contrato/downloadFileById', 'Operacion\ContratoController@downloadFileById');
    ...
    ##Gastos de Operación
    Route::get('/operacion/provision_config/getListGastoOperacion', 'Operacion\ProvisionController@getListGastoOperacion');
