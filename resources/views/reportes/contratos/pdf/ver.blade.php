    ...
    <div class="cabecera">
        ...
        <table width="100%" cellspacing="0" cellspacing="1" border="1" align="center">
            ...
            <tbody>
                ...
                <tr>
                    <th colspan="4" align="center" class="rowDescription">Nombre Fiador:</th>
                    <th colspan="4"><span>{{ $reporte[0]->nombreFiador }}</span></th>
                </tr>
                <tr>
                    <th colspan="2" align="center" class="rowDescription">Calle:</th>
                    <th colspan="2"><span>{{ $reporte[0]->calleFiador }}</span></th>
                    <th colspan="2" align="center" class="rowDescription">Colonia:</th>
                    <th colspan="2"><span>{{ $reporte[0]->coloniaFiador }}</span></th>
                </tr>
                <tr>
                    <th colspan="2" align="center" class="rowDescription">Ciudad:</th>
                    <th colspan="2"><span>{{ $reporte[0]->ciudadFiador }}</span></th>
                    <th colspan="2" align="center" class="rowDescription">CP:</th>
                    <th colspan="2"><span>{{ $reporte[0]->cpFiador }}</span></th>
                </tr>
                <tr>
