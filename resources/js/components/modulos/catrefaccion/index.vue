    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Invetario de Herramientas y Refacciones</h1>
                    </div>
                </div>
            </div>
            <div class="col-12">
                    ...
                    <div class="card-header">
                        <div class="box-header">
                            <div class="col-md-2 row">
                                <router-link class="btn btn-block btn-info" :to="'/catrefaccion/crear'">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control"
                                                            v-model="fillBsqInvetario.cDescripcion"
                                                            @keyup.enter="getListInvetario">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                        ...
                                        <div class="row">
                                            <div class="col text-center">
                                                <button class="btn btn-flat btn-info btnWidth"
                                                    @click.prevent="getListInventario()"
                                ...
                                <div class="box box-info box-solid">
                                    ...
                                    <template v-if="listarInventarioPaginated.length">
                                        <div class="box-body table-responsive">
                                            <table
                                                ...
                                                <tbody>
                                                    <tr v-for="(item, index) in listarInventarioPaginated" :key="index">
                                                        <td v-text="item.descripcion"></td>
                                                        <td v-text="item.tipoinventario"></td>
                                                        <td>
                                                            <!-- <button
                                                                @click="$router.push({ name: 'refaccion.editar', params: { id: item.id } })"
...
export default {
    ...
    computed: {
        ...
        pageCount() {
            let a = this.listInventario.length,
                b = this.perPage;

            return Math.ceil(a / b);
        },
        //Obtener registro paginados
        listarInventarioPaginated() {
            let inicio = this.pageNumber * this.perPage,
                fin = inicio + this.perPage;
            return this.listInventario.slice(inicio, fin);
        },
        pagesList() {
            let a = this.listInventario.length,
                b = this.perPage;
    ...
    methods: {
        limpiarCriteriosBsq() {
            this.fillBsqInvetario.cDescripcion = '';
        },
        getListInventario() {
            this.fullScreenLoading = true;
            var url = '/configuracion/catinventario/getListInventario';
            axios.get(url, {
                params: {
                    'cDescripcion': this.fillBsqInvetario.cDescripcion
                }
            }).then((response) => {
